...
public class stage3_env2_test_3c3s8p : Agent
{
    ...
    public List<List<Vector3>> Position(int pos, int pre)
    {
        ...
        {
            Vector3 element_1 = choose(down.Concat(middle_2).ToList());
            Vector3? element_2 = null;
            while (!element_2.HasValue || Math.Abs(element_2.Value.x - element_1.x) > 1 || Math.Abs(element_2.Value.z - element_1.z) > 1)
            {
                if (element_1.y == 1)
                {
                    element_2 = choose(middle_2.Concat(up).ToList());
                }
                else
                {
                    element_2 = choose(up);
            ...
            xyzList_1.Add(element_1);
            xyzList_2.Add(element_2.Value);
        }
        else if (pre == 2) // In front of
        {
            Vector3 element_1 = choose(middle_3.Concat(back).ToList());
            ...
            else
            {
                ...
                temp.z += (randomValue == 0) ? -1 : -2;
                xyzList_2.Add(temp);
            }
            
            xyzList_1.Add(element_1);
        }
        else if (pre == 3) // Behind
        {   
            Vector3 element_1 = choose(front.Concat(middle_3).ToList());
            Vector3 temp = element_1;
        ...
        else if (pre == 4) // Beside
        {
            Vector3 element_1 = choose(allList);
            Vector3 temp = element_1;
            if (temp.x == -1)
            {
                temp.x += 1;
    ...
    {   
        ...
        int otherObject2_AttributesIndex_1 = Random.Range(0,AttributesList.Count);
        while (otherObject2_AttributesIndex_1==targetAttributesIndex_1)
        {
            otherObject2_AttributesIndex_1 = Random.Range(0,AttributesList.Count);
        }
        int otherObject2_AttributesIndex_2 = Random.Range(0,AttributesList.Count);
        while (otherObject2_AttributesIndex_2==targetAttributesIndex_2 || otherObject2_AttributesIndex_2 == otherObject2_AttributesIndex_1)
        {
            otherObject2_AttributesIndex_2 = Random.Range(0,AttributesList.Count);
        }
        ...
        AttributeTuple otherObject2_Attributes_1 = AttributesList[otherObject2_AttributesIndex_1];
        AttributeTuple otherObject2_Attributes_2 = AttributesList[otherObject2_AttributesIndex_2];
        ...
        // 0 -- Above, 1 -- Below, 2 -- In front of, 3 -- Behind, 4 -- Beside, 5 -- On, 6 -- Between, 7 -- Among
        System.Random rand = new System.Random();
        target_preposition = Random.Range(0,8);
        int otherObject1_preposition;
        int otherObject2_preposition;
        int otherObject3_preposition;
        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            target_preposition = targetAttributes_1.obj;
            otherObject1_preposition = targetAttributes_1.obj + 3;
        }
        else
        {
            target_preposition = targetAttributes_1.obj + 3;
            otherObject1_preposition = targetAttributes_1.obj;
        }

        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            otherObject2_preposition = otherObject2_Attributes_1.obj;
        }
        else
        {
            otherObject2_preposition = otherObject2_Attributes_1.obj + 3;
        }

        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            otherObject3_preposition = otherObject3_Attributes_1.obj;
        }
        else
        {
            otherObject3_preposition = otherObject3_Attributes_1.obj + 3;
        }
        ...
        //--------------OBJECT1---------------------  
        List<List<Vector3>> otherObject1Positions = Position(assigned_pos[1],otherObject1_preposition);
        ...
        {
            GameObject otherObject2 = Instantiate(prefabList[otherObject2_Attributes_1.obj], position, Quaternion.identity);
            otherObject2s_1.Add(otherObject2);
        }
        foreach (Vector3 position in otherObject2Positions[1])
        {
            GameObject otherObject2 = Instantiate(prefabList[otherObject2_Attributes_2.obj], position, Quaternion.identity);
        ...
        {   
            ...
            if (renderer != null)
            {
                ...
                material2_1.color = colorList[targetAttributes_1.color];
            }
        }
        ...
        {   
            ...
            if (renderer != null)
            {
                ...
                // Set the color based on otherObject1_Attributes
                material2_2.color = colorList[targetAttributes_2.color];
            }
        }
        ...
        foreach (GameObject obj in otherObject2s_1)
        {
            ...
            if (renderer != null)
            {
                ...
                material3_1.color = colorList[otherObject2_Attributes_1.color];
            }
        }
        ...
        foreach (GameObject obj in otherObject2s_2)
        {
            ...
            if (renderer != null)
            {
                ...
                // Set the color based on otherObject2_Attributes
                material3_2.color = colorList[otherObject2_Attributes_2.color];
            }
        }
