...
public class stage4_train : Agent
{
    ...
    public List<List<Vector3>> Position(int pos, int pre, int det1, int det2)
    {
        ...
        if (pre == 0) // Above
        {   
            xyzList_1 = choose(up,num1);
            xyzList_2 = choose(down,num2);
        }
        else if (pre == 1) // Below
        {
        ...
        else if (pre == 2) // In front of
        {
            ...
            if (randomValue == 0)
                xyzList_1 = choose(back,num1);
            else if(randomValue == 1)
                xyzList_1 = choose(middle_3,num1);
            ...
            if (temp.z == 1)
            {
                ...
                if (num2>1)
                {         
                    xyzList_2 = choose(middle_3,num2-1);
        ...
        else if (pre == 5) // On
        {
            ...
            Vector3 temp = choose(xyzList_1,1)[0];
            temp.y -= 1;
            Vector3 element_1 = temp;
            if (num2>1)
                {   if(randomValue==0)
                        {
                            xyzList_2 = choose(middle_2,num2-1);
                            while (xyzList_2.Any(item => item == element_1))
                                {
                                    xyzList_2 = choose(middle_2, num2 - 1);
                                }
        ...
        else if (pre == 6) // Between
        {
            ...
            if (num2>2)
                {
                    xyzList_2 = choose(left.Concat(right).ToList(),num2-2);
                    while (xyzList_2.Any(item => item == element_1 || item == element_2))
                        {
                            xyzList_2 = choose(left.Concat(right).ToList(), num2 - 2);
                        }
                }
    ...
    {   
        ...
        if (target_preposition == 7)  //Among A: No some/many B: No a/few/this/that
            {
        ...
        if(target_determiner_1 == 4 || target_determiner_1 == 5 || target_determiner_1 == 6 || target_determiner_1 == 7)
            {
                ...
                if (target_preposition == 6)
                    {
                        while(target_determiner_2==0||target_determiner_1==target_determiner_2)
                            {
                                target_determiner_2 = Random.Range(1,4);
                            }
                    }
            }
        else
            {
                ...
                if (target_preposition == 6)
                    {
                        while(target_determiner_2==0||target_determiner_2==4||target_determiner_2==5||target_determiner_1==target_determiner_2)
                            {
                                target_determiner_2 = Random.Range(1,8);
                            }
                    }
            }
