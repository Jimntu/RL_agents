...
public class stage3_env2_train_simple : Agent
{
    ...
    {   
        ...
        while(targetAttributes_1.obj == target_preposition)
        {
            target_preposition = Random.Range(0,3);
        }
        int otherObject2_preposition = Random.Range(0,3);
        while(targetAttributes_1.obj == otherObject2_preposition  || target_preposition == otherObject2_preposition)
        {
            otherObject2_preposition = Random.Range(0,3);
        }
        int otherObject3_preposition = Random.Range(0,3);
        while(otherObject3_Attributes_1.obj == otherObject3_preposition || target_preposition == otherObject3_preposition)
        {
