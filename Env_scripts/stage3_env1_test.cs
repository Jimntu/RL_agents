...
public class stage3_env1_test : Agent
{
    ...
    public List<Vector3> Position(int pos, int det)
    {
        ...
        List<List<int>> nums = new List<List<int>>
        {
            ...
            new List<int> { 1 },
            new List<int> { 1 },
            new List<int> { 2, 3, 4, 5, 6},  // 7-9 conflicts with many
    ...
    {   
        ...
        System.Random rand = new System.Random();
        int otherObject1_determiner;
        int otherObject2_determiner;
        int otherObject3_determiner;
        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            target_determiner = targetAttributes.obj;
            otherObject1_determiner = targetAttributes.obj + 3;
        }
        else
        {
            target_determiner = targetAttributes.obj + 3;
            otherObject1_determiner = targetAttributes.obj;
        }

        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            otherObject2_determiner = otherObject2_Attributes.obj;
        }
        else
        {
            otherObject2_determiner = otherObject2_Attributes.obj + 3;
        }

        if (UnityEngine.Random.Range(0, 2) == 0)
        {
            otherObject3_determiner = otherObject3_Attributes.obj;
        }
        else
        {
            otherObject3_determiner = otherObject3_Attributes.obj + 3;
        }
        ...
        {
            int[] posOptions1 = { 2, 0, 3, 1 };
            int[] posOptions2 = { 3, 1, 2, 0 };
            int[] posOptions3 = { 2, 0, 1, 3 };
        ...
        //--------------OBJECT1---------------------  
        List<Vector3> otherObject1Positions = Position(assigned_pos[1],otherObject1_determiner); 
        otherObject1s = new List<GameObject>();
        foreach (Vector3 position in otherObject1Positions)
        {
            GameObject otherObject1 = Instantiate(prefabList[targetAttributes.obj], position, Quaternion.identity);
        ...
        {
            GameObject otherObject2 = Instantiate(prefabList[otherObject2_Attributes.obj], position, Quaternion.identity);
        ...
        {   
            ...
            if (renderer != null)
            {
                ...
                material2.color = colorList[targetAttributes.color];
            }
        }
        ...
        foreach (GameObject obj in otherObject2s)
        {
            ...
            if (renderer != null)
            {
                ...
                material3.color = colorList[otherObject2_Attributes.color];
            }
        }
