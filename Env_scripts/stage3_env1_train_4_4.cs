...
public class stage3_env1_train_4_4 : Agent
{
    ...
    {   
        ...
        System.Random rand = new System.Random();
        target_determiner = Random.Range(0,4);
        if (targetAttributes.obj == 0)
        {
            while (target_determiner == 1)
            {
                target_determiner = Random.Range(0,4);
            }
        }
        else if (targetAttributes.obj == 1)
        {
            while(target_determiner == 0 || target_determiner == 2)
            {
                target_determiner = Random.Range(0,4);
            }
        }
        else if (targetAttributes.obj == 3)
        {
            while(target_determiner == 1)
            {
                target_determiner = Random.Range(0,4);
        ...
        {
            while(target_determiner == 2 || target_determiner == 3)
            {
                target_determiner = Random.Range(0,4);
            }
        }
        ...
        int otherObject2_determiner = Random.Range(0,4);
        
        if (target_determiner == 0 || target_determiner == 1)  //Target: Few, Many, Some  Others: No these/those
        {
            while (otherObject2_determiner == 3 || target_determiner == otherObject2_determiner)
            {
                otherObject2_determiner = Random.Range(0,4);
            }
        }
        else
        {
            while(target_determiner == otherObject2_determiner)
            {
                otherObject2_determiner = Random.Range(0,4);
            }
        }

        int otherObject3_determiner = Random.Range(0,4);
        while(target_determiner == otherObject3_determiner || otherObject2_determiner == otherObject3_determiner)
        {
            otherObject3_determiner = Random.Range(0,4);
        }

        if (target_determiner == 2) // target -- this or these
        {
        ...
        else if (target_determiner == 3) // that or those
        {
