...
public class stage3_env2_train_3c3s8p : Agent
{
    ...
    {   
        ...
        while(targetAttributes_1.obj == target_preposition || targetAttributes_1.obj + 3 == target_preposition)
        {
            target_preposition = Random.Range(0,8);
        }
        int otherObject2_preposition = Random.Range(0,8);
        while(targetAttributes_1.obj == otherObject2_preposition || targetAttributes_1.obj + 3 == otherObject2_preposition || target_preposition == otherObject2_preposition)
        {
            otherObject2_preposition = Random.Range(0,8);
        }
        int otherObject3_preposition = Random.Range(0,8);
        while(otherObject3_Attributes_1.obj == otherObject3_preposition || otherObject3_Attributes_1.obj + 3 == otherObject3_preposition || target_preposition == otherObject3_preposition || otherObject2_preposition == otherObject3_preposition)
        {
            otherObject3_preposition = Random.Range(0,8);
        }
